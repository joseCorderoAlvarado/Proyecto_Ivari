...
>>>>>>> 32809440cab645b43f901f595d9d85cd8d2d34ad
					Compras realizadas
				</a>
					...
					<hr style="margin-bottom: 40px;">
						...
						<div class="form-group" style="background-color: #E0E0E0;">
							...
							<div class="row">
								...
								<div class="col-7">
									<input id="text" type="text" readonly="true" name="txtApellidoP" contenteditable="false" style="width: 400px;  border: none; background-color: transparent; color: #9FA5AB;" value="{{$usuarioDatos[0]->apellidopaterno}}">
								</div>
								<div class="col-1">
							...
							<div class="row">
								...
								<div class="col-7">
									<input id="text" type="text" readonly="true" name="txtApellidoM"  contenteditable="false" style="width: 400px; border: none; background-color: transparent; color: #9FA5AB;" value="{{$usuarioDatos[0]->apellidomaterno}}">
								</div>
								<div class="col-1">
						...
						<div class="form-group" style="background-color: #E0E0E0;">
							<div class="row">
								...
								<div class="col-4">
									<input id="text" type="text" readonly="true" name="txtCalle" contenteditable="false" style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->calle}}">
								</div>
								<div class="col-2">
									<label id="text" >N&uacute;mero:</label>
								</div>
								<div class="col-2">
									<input id="text" type="text" readonly="true" name="txtNumero" contenteditable="false" style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->numint}}">
							...
							<div class="row">
								...
								<div class="col-4">
									<input id="text" type="text" readonly="true" name="txtColonia" contenteditable="false" style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->colonia}}">
								...
								<div class="col-2">
									<input id="text" type="text" readonly="true" name="txtCodigoP" contenteditable="false"  style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->codigopostal}}">
							...
							<div class="row">
								...
								<div class="col-4">
									<input id="text" type="text" readonly="true" name="txtMunicipio" contenteditable="false" style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->municipio}}">
								...
								<div class="col-2">
									<input id="text" type="text" readonly="true" name="txtEstado" contenteditable="false" style="width:200px;  border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->ciudad}}">

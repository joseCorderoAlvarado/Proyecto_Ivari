...
<div class="col-md-12">
	...
	<center>
		<div class="toggle toggle2">
            <span>
            	<div class="col-6">
					<a href="#registrarUsuario" role="button" class="btn btn-large btn-primary" style="width: 200px;background-color: #003669; color: white;"
					data-toggle="modal" >Mostrar formulario</a>
				</div></span>
        </div></center><br>
          <div class="mensaje">
        	<br><br>

...
<div class="card" style="border-color: #003366">
  <article class="card-body">
	...
	<div class="input-group">
		...
		<input name="nombre" class="form-control formulario-input" type="text" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="app" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z]+"
	...
	<div class="input-group">
		...
		<input name="apm" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z]+"
		title="El apellido debe llevar solo letras" required>
	...
	<div class="input-group">
		...
		<input type="date" name="nacimiento" class="form-control formulario-input" style="border-color: #666699" required>
	...
	<div class="input-group">
		...
		<input name="calle" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="colonia" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="ninterior" class="form-control formulario-input" style="border-color: #666699" pattern="[0-9]+"
	...
	<div class="input-group">
		...
		<input name="nexterior" class="form-control formulario-input" style="border-color: #666699" pattern="[0-9]+"
	...
	<div class="input-group">
		...
		<input name="pais" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="municipio" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="ciudad" class="form-control formulario-input" style="border-color: #666699" pattern="[A-Za-z\s]+"
	...
	<div class="input-group">
		...
		<input name="cp" class="form-control formulario-input" style="border-color: #666699" pattern="[0-9]{5}"
	...
	<div class="input-group">
		...
		<input name="telefono" class="form-control formulario-input" style="border-color: #666699" pattern="[0-9]+"
	...
	<div class="input-group">
		...
		<input type="email" name="correo" class="form-control formulario-input"  style="border-color: #666699">
	...
	<div class="input-group">
		...
		<input type="password" name="contraseña" class="form-control formulario-input" style="border-color: #666699"
		pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 

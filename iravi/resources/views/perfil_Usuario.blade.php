					...
					<hr style="margin-bottom: 40px;">
						...
						<div class="form-group" style="background-color: #E0E0E0;">
							<div class="row">
								...
								<div class="col-2">
									<input id="text" type="text" readonly="true" name="txtNumero" contenteditable="false" style=" border: none; background-color: transparent; color: #9FA5AB;" value="{{$direccion->numext}}">
